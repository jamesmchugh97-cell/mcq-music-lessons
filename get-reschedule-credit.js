...
exports.handler = async function (event) {
  ...
  try {
    ...
    if (todayStr > credit.weekEnd) {
      return { statusCode: 200, body: JSON.stringify({ valid: false, error: 'This reschedule link has expired. It was only valid for a fortnight from your cancelled lesson. Please contact James directly.' }) };
    }
