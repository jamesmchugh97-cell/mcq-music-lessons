...
exports.handler = async function (event) {
  ...
  try {
    ...
    if (todayStr > credit.weekEnd) {
      return { statusCode: 200, body: JSON.stringify({ valid: false, error: 'This reschedule link has expired \u2014 it was only valid for the same week as your cancelled lesson. Please contact James directly.' }) };
    }
